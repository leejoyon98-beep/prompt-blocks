...
const useExamples = [
  { command: "핵심요약 + ELI5 + table:", request: "아래 내용을 정리해줘." },
  { command: "고객분석 + 구매장벽분석 + benefits:", request: "이 제품을 고객 관점에서 분석해줘." },
  { command: "이미지프롬프트 + mood + lighting:", request: "아래 콘셉트를 이미지 생성용 프롬프트로 바꿔줘." },
  { command: "딥리서치 + sources + evidence + next steps:", request: "아래 주제에 대해 근거 중심으로 조사하고 다음 액션까지 정리해줘." },
];
