...
export const promptTags: PromptTag[] = [
  {
    ...
    "similarTags": [
      ...
      {
        "tag": "concise",
        "difference": "concise는 답변 전체의 길이와 표현을 간결하게 줄이고, TL;DR은 긴 답변 앞에 붙는 짧은 요약만 추가하는 태그예요."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "similarTags": [
      ...
      {
        "tag": "concise",
        "difference": "concise는 답변 전체를 짧고 압축하고, humanize는 글의 길이보다 문장 리듬과 흐름을 사람 글처럼 자연스럽게 조정해요."
      }
    ]
  },
  {
